...
const MobileGroundStation = () => {
  ...
  const heroImage =
    "https://images.pexels.com/photos/9022678/pexels-photo-9022678.jpeg?auto=compress&cs=tinysrgb&w=1920";

  const specifications: Specification[] = [
    { label: "Antenna Diameter", value: "2.4m foldable" },
    { label: "Frequency Bands", value: "X/Ku" },
    { label: "G/T", value: ">35 dB/K" },
    { label: "EIRP", value: ">50 dBW" },
    { label: "Power Consumption", value: "<300W" },
    { label: "Operating Temp", value: "-30°C to +50°C" },
    { label: "Deployed Footprint", value: "5m x 3m" },
  ...
  const features: Feature[] = [
    {
      ...
      description:
        "Vehicle-integrated design allows setup in minutes, perfect for dynamic mission requirements and on-the-go connectivity.",
    },
    {
      icon: <Wifi className="w-6 h-6" />,
      title: "Versatile Connectivity",
      description:
        "Multi-band support with integrated modem for reliable data links in challenging environments.",
    },
    {
      icon: <CheckCircle className="w-6 h-6" />,
      title: "Global Mobility",
      description:
        "Rugged construction for worldwide transport, with shock/vibration resistance for air, sea, and land deployment.",
    },
  ];
  ...
  const applications: Application[] = [
    {
      ...
      description:
        "Quick deployment for emergency communications in remote or affected areas.",
      image:
    ...
    },
    {
      ...
      description:
        "Mobile satellite links for on-site data collection and real-time monitoring.",
      image:
    ...
    },
    {
      ...
      description:
        "Secure, portable comms for tactical operations and reconnaissance.",
      image:
  ...
  const downloadSpecs = () => {
    ...
    doc.text("Mobile Ground Station Specifications", pageWidth / 2, 25, {
      align: "center",
    });
    doc.setLineWidth(1);
    ...
    doc.save("mobile_ground_station_specifications.pdf");
  };
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-4 max-w-5xl mx-auto">
          <h1 className="text-6xl md:text-7xl font-bold text-white mb-6 animate-fade-in">
            Mobile <span className="text-cyan-400">Ground Station</span>
          </h1>
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Deploy satellite connectivity anywhere with compact, vehicle-mounted
            stations for rapid setup.
          </p>
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-cyan-500/20">
            <div className="relative aspect-video bg-slate-800">
              {!isVideoPlaying ? (
                <>
                  <img
                    src="https://images.pexels.com/photos/9022678/pexels-photo-9022678.jpeg?auto=compress&cs=tinysrgb&w=1920"
                    alt="Mobile Ground Station assembly"
                ...
                <iframe
                  src="https://www.youtube.com/embed/hfI-5YYYqh4"
                  className="w-full h-full"
                  title="Mobile Ground Station Demo"
                  frameBorder="0"
          ...
          {activeTab === "overview" && (
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 animate-fade-in">
              {features.map((feature, index) => (
                ...
                >
                  <img
                    src="https://images.pexels.com/photos/9022678/pexels-photo-9022678.jpeg?auto=compress&cs=tinysrgb&w=500"
      ...
      <section className="py-20 px-4 bg-slate-800/30">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-white text-center mb-12">
            Mobile Ground Station <span className="text-cyan-400">Gallery</span>
          </h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="relative h-64 rounded-xl overflow-hidden group">
              <img
                src={heroImage}
                alt="Mobile Ground Station design"
            ...
            <div className="relative h-64 rounded-xl overflow-hidden group">
              <img
                src="https://images.pexels.com/photos/8346132/pexels-photo-8346132.jpeg?auto=compress&cs=tinysrgb&w=800"
                alt="Mobile Ground Station testing"
                className="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-500"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-slate-900 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            </div>
            <div className="relative h-64 rounded-xl overflow-hidden group">
              <img
                ...
                alt="Mobile Ground Station deployment"
                className="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-500"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-slate-900 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-white mb-6">
            Mobilize Your Satellite Operations
          </h2>
          <p className="text-xl text-gray-400 mb-8">
            Let's configure a mobile solution that fits your fieldwork needs.
...
export default MobileGroundStation;
